...
| ------------------------ | -------------------------- | --------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------- | ---------------------- | --------------- |
| `backdropDismiss`        | `backdrop-dismiss`         | <span style="color:red">**[DEPRECATED]**</span> boolean props should always default to being false per html specs, use preventBackdropDismiss instead, will be removed in v0.27.0. Pass false to remove the backdrop click auto-dismiss feature.<br/><br/>                                                                                                                                                | `boolean`              | `true`          |
...
| `showCloseButton`        | `show-close-button`        | <span style="color:red">**[DEPRECATED]**</span> boolean props should always default to being false per html specs, use hideCloseButton instead, will be removed in v0.27.0. Optionally you can pass false to not show the close button. If you decide to do so, you should either not also prevent dismissal by clicking the backdrop or provide your own dismissal logic in the modal content.<br/><br/> | `boolean \| undefined` | `true`          |
