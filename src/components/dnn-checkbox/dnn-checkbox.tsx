 ...
 * @slot checked - Allows overriding the default checked icon.
 * @slot unchecked - Allows overriding the unchecked icon.
 * @slot intermediate - If intermadiate state is used, allows overriding its icon.
 */
@Component({
  tag: 'dnn-checkbox',
