import{x as t}from"./lit-element-BTykW0Pr.js";const r=`# dnn-example-form
...
`,a={title:"Examples/Form",component:"dnn-example-form",tags:["autodocs"],parameters:{docs:{description:{component:r}}}},m=()=>t`
        <dnn-example-form>
        </dnn-example-form>
    `,n=m.bind({});var e,o,d;n.parameters={...n.parameters,docs:{...(e=n.parameters)==null?void 0:e.docs,source:{originalSource:`() => html\`
        <dnn-example-form>
        </dnn-example-form>
    \``,...(d=(o=n.parameters)==null?void 0:o.docs)==null?void 0:d.source}}};const l=["DnnFormExample"];export{n as DnnFormExample,l as __namedExportsOrder,a as default};
