import{n as e}from"./chunk-BneVvdWh.js";import{_ as t,b as n}from"./iframe-BqLFqqtI.js";import{n as r,t as i}from"./if-defined-CEWZc3-b.js";var a,o=e((()=>{a=`# dnn-collapsible
...
`})),s,c,l,u,d;e((()=>{t(),i(),o(),{actions:s}=__STORYBOOK_MODULE_ACTIONS__,c={title:`Elements/Collapsible`,component:`dnn-collapsible`,tags:[`autodocs`],parameters:{docs:{description:{component:a}}},argTypes:{expanded:{type:`boolean`},transitionDuration:{type:`number`,control:`number`}}},s(`dnnCollapsibleHeightChanged`),l=e=>(document.querySelector(`#dnn-chevron1`),n`
        <div class="collapse-row">
            <style type="text/css">
                .collapse-row{
                    border: 1px solid grey;
            ...
            <div class="collapse-title">
                <dnn-chevron @changed=${e=>{let t=document.querySelector(`#dnn-collapsible1`);console.log(t),t.expanded=e.detail}} expanded=${e.expanded} id="dnn-chevron1"></dnn-chevron>
                <strong>Collapsible Panel</strong>
            </div>
            <dnn-collapsible ?expanded=${r(e.expanded)} id="dnn-collapsible1" transition-duration="300">
                <div id="collapsible-slot-content" style="padding: 15px;">
                    <h2>Details</h2>
                    <p>
                        Spicy jalapeno bacon ipsum dolor amet bresaola kielbasa doner ham hock biltong, swine shoulder leberkas cupim. Sausage capicola buffalo, tongue jerky frankfurter biltong pork swine landjaeger. Porchetta alcatra burgdoggen beef ribs short ribs corned beef, biltong flank bresaola kielbasa. Ham hock beef kielbasa, cupim cow beef ribs doner. T-bone cow shoulder chuck pastrami. Alcatra pig filet mignon shank. Pancetta shankle meatloaf sausage meatball cupim.
    ...
    `),u=l.bind({}),u.args={expanded:!1,transitionDuration:150},u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`(args: {
  expanded: boolean;
  ...
  return html\`
    ...
    \`;
}`,...u.parameters?.docs?.source}}},d=[`Collapsible`]}))();export{u as Collapsible,d as __namedExportsOrder,c as default};