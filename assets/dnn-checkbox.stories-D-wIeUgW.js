import{b as c}from"./iframe-CDvZgNwq.js";import{o as t}from"./if-defined-BziqozOC.js";import"./preload-helper-PPVm8Dsz.js";const r=`# dnn-checkbox
...
`,{actions:o}=__STORYBOOK_MODULE_ACTIONS__,s={title:"Elements/Checkbox",component:"dnn-checkbox",tags:["autodocs"],parameters:{docs:{description:{Component:r}}},argTypes:{checked:{options:["checked","unchecked","intermediate"],control:"radio"},useIntermediate:{control:"boolean"},value:{control:"text"},required:{control:"boolean"}}};o("checkedchange");const n={args:{checked:"unchecked",useIntermediate:!1,value:"1",required:!1},render:e=>c`
            <dnn-checkbox
                checked=${e.checked}
  ...
  render: args => html\`
            ...
            />
        \`
}`,...n.parameters?.docs?.source}}};const h=["Checkbox"];export{n as Checkbox,h as __namedExportsOrder,s as default};
