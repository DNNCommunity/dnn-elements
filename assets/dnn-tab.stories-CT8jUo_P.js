import{n as e}from"./chunk-BneVvdWh.js";import{_ as t,b as n}from"./iframe-BqLFqqtI.js";import{n as r,t as i}from"./if-defined-CEWZc3-b.js";var a,o=e((()=>{a=`# dnn-tab
...
`})),s,c,l,u;e((()=>{t(),i(),o(),s={title:`Elements/Tab`,component:`dnn-tab`,tags:[`autodocs`],parameters:{docs:{description:{component:a}}},argTypes:{"tab-title":{control:`text`}}},c=e=>n`
    <dnn-tabs >
      <dnn-tab tab-title=${r(e.tabTitle)+` 1`}>
      ...
      <dnn-tab tab-title=${r(e.tabTitle)+` 2`}>
      ...
      <dnn-tab tab-title=${r(e.tabTitle)+` 3`}>
    ...
    `,l=c.bind({}),l.args={tabTitle:`Tab`},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`args => html\`
    <dnn-tabs >
    ...
    \``,...l.parameters?.docs?.source}}},u=[`Tab`]}))();export{l as Tab,u as __namedExportsOrder,s as default};