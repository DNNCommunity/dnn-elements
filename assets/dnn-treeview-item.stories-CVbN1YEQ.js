import{n as e}from"./chunk-BneVvdWh.js";import{_ as t,b as n}from"./iframe-BqLFqqtI.js";import{n as r,t as i}from"./if-defined-CEWZc3-b.js";var a,o=e((()=>{a=`# dnn-treeview-item
...
`})),s,c,l,u,d,f,p,m,h,g;e((()=>{t(),i(),o(),s={title:`Elements/Treeview Item`,component:`dnn-treeview-item`,tags:[`autodocs`],parameters:{docs:{description:{component:a}}},argTypes:{expanded:{control:`boolean`}}},c=e=>n`
        <dnn-treeview-item
    ...
    `,l=e=>n`
        <section>
        <dnn-treeview-item expanded=${r(e.expanded)}>
      ...
      `,f=c.bind({}),f.args={expanded:!1},p=l.bind({}),p.args={expanded:!1},m=u.bind({}),p.args={expanded:!1},h=d.bind({}),p.args={expanded:!1},f.parameters={...f.parameters,docs:{...f.parameters?.docs,source:{originalSource:`(args: {
  expanded: boolean;
}) => html\`
        <dnn-treeview-item
  ...
  expanded: boolean;
      ...
      \``,...h.parameters?.docs?.source}}},g=[`Basic`,`Icons`,`Linked`,`DropDown`]}))();export{f as Basic,h as DropDown,p as Icons,m as Linked,g as __namedExportsOrder,s as default};