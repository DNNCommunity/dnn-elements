import{n as e}from"./chunk-BneVvdWh.js";import{_ as t,b as n}from"./iframe-BqLFqqtI.js";var r,i=e((()=>{r=`# dnn-tabs
...
`})),a,o,s,c;e((()=>{t(),i(),a={title:`Elements/Tabs`,component:`dnn-tabs`,tags:[`autodocs`],parameters:{docs:{description:{component:r}}},argTypes:{colorBackground:{control:`color`},colorFocus:{control:`color`},colorText:{control:`color`},colorVisible:{control:`color`},colorVisibleText:{control:`color`}}},o=(e,t)=>n`
    <style type="text/css">
        p {margin:10px} 
    </style>
    ...
    `,s=o.bind({}),s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`(args, context) => {
  return html\`
    <style type="text/css">
        p {margin:10px} 
    </style>
    ...
    \`;
}`,...s.parameters?.docs?.source}}},c=[`Tabs`]}))();export{s as Tabs,c as __namedExportsOrder,a as default};