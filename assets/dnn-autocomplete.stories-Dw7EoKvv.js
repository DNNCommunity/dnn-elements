import{n as e}from"./chunk-BneVvdWh.js";import{_ as t,b as n}from"./iframe-BqLFqqtI.js";var r,i=e((()=>{r=`# dnn-autocomplete
...
| \`renderSuggestion\`       | --                         | Callback to render suggestions, if not provided, only the label will be rendered.                                                                                                                     | \`((suggestion: DnnAutocompleteSuggestion) => HTMLElement) \\| undefined\` | \`undefined\` |
...
`})),a,o,s,c,l,u;e((()=>{t(),i(),{actions:a}=__STORYBOOK_MODULE_ACTIONS__,o={title:`Elements/AutoComplete`,component:`dnn-autocomplete`,tags:[`autodocs`],parameters:{docs:{description:{component:r}}},argTypes:{disabled:{control:`boolean`},helpText:{control:`text`},label:{control:`text`},name:{control:`text`},preloadThresholdPixels:{control:`number`},renderSuggestions:{control:`object`},required:{control:`boolean`},suggestions:{control:`object`},totalSuggestions:{control:`number`},value:{control:`text`},onSearchQueryChanged:{action:`onSearchQueryChanged`}}},s=a(`itemSelected`,`needMoreItems`,`searchQueryChanged`,`valueChange`,`valueInput`),c=e=>n`
    <dnn-autocomplete
        .disabled=${e.disabled}
        .helpText=${e.helpText}
        .label=${e.label}
        ...
        .value=${e.value}
        @itemSelected=${e=>s.itemSelected(e)}
        @needMoreItems=${e=>s.needMoreItems(e)}
        @searchQueryChanged=${e.onSearchQueryChanged?e.onSearchQueryChanged:e=>s.searchQueryChanged(e)}
        @valueChange=${e=>s.valueChange(e)}
        @valueInput=${e=>s.valueInput(e)}
    >
    </dnn-autocomplete>
    `,l=c.bind({}),l.args={label:`Autocomplete`},l.parameters={...l.parameters,docs:{...l.parameters?.docs,source:{originalSource:`args => html\`
    <dnn-autocomplete
    ...
    \``,...l.parameters?.docs?.source}}},u=[`Primary`]}))();export{l as Primary,u as __namedExportsOrder,o as default};