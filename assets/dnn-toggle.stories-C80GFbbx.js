import{x as r}from"./lit-element-BTykW0Pr.js";import{o}from"./if-defined-rEY2lmWu.js";import{a as c}from"./index-BMoMLr6o.js";import"./v4-CtRu48qb.js";const l=`# dnn-toggle
...
`,f={title:"Elements/Toggle",component:"dnn-toggle",tags:["autodocs"],parameters:{docs:{description:{component:l}}},argTypes:{checked:{control:"boolean"},disabled:{control:"boolean"},background:{control:"color"},backgroundChecked:{control:"color"},handleBackground:{control:"color"},handleBackgroundChecked:{control:"color"},borderRadius:{control:"text"},handleBorderRadius:{control:"text"}}};c("checkChanged");const s=(n,g)=>r`
  ...
  disabled: boolean;
    ...
    \``,...(a=(t=e.parameters)==null?void 0:t.docs)==null?void 0:a.source}}};const k=["Toggle"];export{e as Toggle,k as __namedExportsOrder,f as default};
