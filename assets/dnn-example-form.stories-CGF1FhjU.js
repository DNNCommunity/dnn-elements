import{n as e}from"./chunk-BneVvdWh.js";import{_ as t,b as n}from"./iframe-BqLFqqtI.js";var r,i=e((()=>{r=`# dnn-example-form
...
`})),a,o,s,c;e((()=>{t(),i(),a={title:`Examples/Form`,component:`dnn-example-form`,tags:[`autodocs`],parameters:{docs:{description:{component:r}}}},o=()=>n`
        <dnn-example-form>
        </dnn-example-form>
    `,s=o.bind({}),s.parameters={...s.parameters,docs:{...s.parameters?.docs,source:{originalSource:`() => html\`
        <dnn-example-form>
        </dnn-example-form>
    \``,...s.parameters?.docs?.source}}},c=[`DnnFormExample`]}))();export{s as DnnFormExample,c as __namedExportsOrder,a as default};