import{b as t}from"./iframe-mofKu0_g.js";import"./preload-helper-PPVm8Dsz.js";const r=`# dnn-tabs
...
`,l={title:"Elements/Tabs",component:"dnn-tabs",tags:["autodocs"],parameters:{docs:{description:{component:r}}},argTypes:{colorBackground:{control:"color"},colorFocus:{control:"color"},colorText:{control:"color"},colorVisible:{control:"color"},colorVisibleText:{control:"color"}}},n=(e,o)=>t`
    <style type="text/css">
        p {margin:10px} 
    </style>
    ...
    `,a=n.bind({});a.parameters={...a.parameters,docs:{...a.parameters?.docs,source:{originalSource:`(args, context) => {
  return html\`
    <style type="text/css">
        p {margin:10px} 
    </style>
    ...
    \`;
}`,...a.parameters?.docs?.source}}};const c=["Tabs"];export{a as Tabs,c as __namedExportsOrder,l as default};
