import{b as s}from"./iframe-CDvZgNwq.js";import"./preload-helper-PPVm8Dsz.js";const o=`# dnn-autocomplete
...
`,{actions:a}=__STORYBOOK_MODULE_ACTIONS__,d={title:"Elements/AutoComplete",component:"dnn-autocomplete",tags:["autodocs"],parameters:{docs:{description:{component:o}}},argTypes:{disabled:{control:"boolean"},helpText:{control:"text"},label:{control:"text"},name:{control:"text"},preloadThresholdPixels:{control:"number"},renderSuggestions:{control:"object"},required:{control:"boolean"},suggestions:{control:"object"},totalSuggestions:{control:"number"},value:{control:"text"},onSearchQueryChanged:{action:"onSearchQueryChanged"}}},t=a("itemSelected","needMoreItems","searchQueryChanged","valueChange","valueInput"),i=e=>s`
    <dnn-autocomplete
        .disabled=${e.disabled}
        .helpText=${e.helpText}
        .label=${e.label}
    ...
    `,r=i.bind({});r.args={label:"Autocomplete"};r.parameters={...r.parameters,docs:{...r.parameters?.docs,source:{originalSource:`args => html\`
    <dnn-autocomplete
    ...
    \``,...r.parameters?.docs?.source}}};const h=["Primary"];export{r as Primary,h as __namedExportsOrder,d as default};
