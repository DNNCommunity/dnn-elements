import{b as n}from"./iframe-EVDCHu82.js";import{o as i}from"./if-defined-C5JsQu7Z.js";import"./preload-helper-PPVm8Dsz.js";const o=`# dnn-vertical-splitview
...
`,{actions:a}=__STORYBOOK_MODULE_ACTIONS__,c={title:"Elements/Vertical Splitview",component:"dnn-vertical-splitview",tags:["autodocs"],parameters:{docs:{description:{component:o}}},argTypes:{splitterWidth:{control:"number"},splitWidthPercentage:{control:"number"},leftPaneBackgroundColor:{control:"color"},rightPaneBackgroundColor:{control:"color"}}};a("widthChanged");const r=(t,l)=>n`
<dnn-vertical-splitview
    id="split-view-demo"
    ...
    `,e=r.bind({});e.args={splitterWidth:16,splitWidthPercentage:30};e.parameters={...e.parameters,docs:{...e.parameters?.docs,source:{originalSource:`(args: {
...
<dnn-vertical-splitview
    ...
    \``,...e.parameters?.docs?.source}}};const p=["VerticalSplitview"];export{e as VerticalSplitview,p as __namedExportsOrder,c as default};
