import{n as e}from"./chunk-BneVvdWh.js";import{_ as t,b as n}from"./iframe-BqLFqqtI.js";import{n as r,t as i}from"./if-defined-CEWZc3-b.js";var a,o=e((()=>{a=`# dnn-vertical-splitview
...
`})),s,c,l,u,d;e((()=>{t(),i(),o(),{actions:s}=__STORYBOOK_MODULE_ACTIONS__,c={title:`Elements/Vertical Splitview`,component:`dnn-vertical-splitview`,tags:[`autodocs`],parameters:{docs:{description:{component:a}}},argTypes:{splitterWidth:{control:`number`},splitWidthPercentage:{control:`number`},leftPaneBackgroundColor:{control:`color`},rightPaneBackgroundColor:{control:`color`}}},s(`widthChanged`),l=(e,t)=>n`
<dnn-vertical-splitview
    id="split-view-demo"
    splitter-width=${r(e.splitterWidth)}
    split-width-percentage=${r(e.splitWidthPercentage)}
    ...
    `,u=l.bind({}),u.args={splitterWidth:16,splitWidthPercentage:30},u.parameters={...u.parameters,docs:{...u.parameters?.docs,source:{originalSource:`(args: {
...
<dnn-vertical-splitview
    ...
    \``,...u.parameters?.docs?.source}}},d=[`VerticalSplitview`]}))();export{u as VerticalSplitview,d as __namedExportsOrder,c as default};